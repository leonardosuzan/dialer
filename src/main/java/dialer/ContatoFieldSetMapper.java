...
public class ContatoFieldSetMapper implements FieldSetMapper<Contato> {
	...
	public Contato mapFieldSet(FieldSet arg0) throws BindException {
		...
		contato.setEndereco(arg0.readString(4));
		contato.setNumeroEndereco(arg0.readString(5));
		contato.setComplemento(arg0.readString(6));
		contato.setBairro(arg0.readString(7));
		contato.setCidade(arg0.readString(8));
		contato.setEstado(arg0.readString(9));
